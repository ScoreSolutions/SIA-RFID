...
Namespace Table
    'Represents a transaction for TB_RESERVE_JOB table DAL.
    '[Create by  on December, 26 2010]
    Public Class TbReserveJobDAL
        Public Sub TbReserveJobDAL()

        End Sub
        ' TB_RESERVE_JOB
        Const _tableName As String = "TB_RESERVE_JOB"
        ...
        '/// Returns an indication whether the current data is inserted into TB_RESERVE_JOB table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_RESERVE_JOB table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_RESERVE_JOB table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_RESERVE_JOB by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_RESERVE_JOB by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbReserveJobData
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if update data successfully; otherwise, false.</returns>
        Public Function UpdateByJOB_NO(ByVal cJOB_NO As String, ByVal UserID As String, ByVal trans As SQLTransaction) As Boolean
            _UPDATEBY = UserID
            _UPDATEON = DateTime.Now
            Return doUpdate("JOB_NO = " & DB.SetString(cJOB_NO) & " ", trans)
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if delete data successfully; otherwise, false.</returns>
        Public Function DeleteByJOB_NO(ByVal cJOB_NO As String, ByVal trans As SQLTransaction) As Boolean
            Return doDelete("JOB_NO = " & DB.SetString(cJOB_NO) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_RESERVE_JOB by specified JOB_NO key is retrieved successfully.
        '/// <param name=cJOB_NO>The JOB_NO key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByJOB_NO(ByVal cJOB_NO As String, ByVal trans As SQLTransaction) As Boolean
            Return doChkData("JOB_NO = " & DB.SetString(cJOB_NO) & " ", trans)
        End Function

        '/// Returns an indication whether the Data Class of TB_RESERVE_JOB by specified JOB_NO key is retrieved successfully.
        '/// <param name=cJOB_NO>The JOB_NO key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByJOB_NO(ByVal cJOB_NO As String, ByVal trans As SQLTransaction) As TbReserveJobData
            Return doGetMappingData("JOB_NO = " & DB.SetString(cJOB_NO) & " ", trans)
        End Function

        '/// Returns an indication whether the record of TB_RESERVE_JOB by specified condition is retrieved successfully.
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("job_no")) = False Then _job_no = Rdr("job_no").ToString()
                        If Convert.IsDBNull(Rdr("job_date")) = False Then _job_date = Convert.ToDateTime(Rdr("job_date"))
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_RESERVE_JOB by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbReserveJobData, ByVal RDr As DataRow) As TbReserveJobData
            If Convert.IsDBNull(Rdr("id")) = False Then ret.ID = Convert.ToInt64(Rdr("id"))
            If Convert.IsDBNull(Rdr("job_no")) = False Then ret.JOB_NO = Rdr("job_no").ToString()
            If Convert.IsDBNull(Rdr("job_date")) = False Then ret.JOB_DATE = Convert.ToDateTime(Rdr("job_date"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbReserveJobData
            ClearData()
            _haveData = False
            Dim ret As New TbReserveJobData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_RESERVE_JOB
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, JOB_NO, JOB_DATE, MEMBER_ID, MEMBER_NAME, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetString(_JOB_NO) & ", "
                sql += DB.SetDateTime(_JOB_DATE) & ", "
                sql += DB.SetDouble(_MEMBER_ID) & ", "
        ...
        'Get update statement form table TB_RESERVE_JOB
        Private ReadOnly Property SqlUpdate() As String
            Get
                Dim Sql As String = ""
                Sql += "UPDATE " & tableName & " SET "
                Sql += "ID = " & DB.SetDouble(_ID) & ", "
                Sql += "JOB_NO = " & DB.SetString(_JOB_NO) & ", "
                Sql += "JOB_DATE = " & DB.SetDateTime(_JOB_DATE) & ", "
                Sql += "MEMBER_ID = " & DB.SetDouble(_MEMBER_ID) & ", "
        ...
        'Get Delete Record in table TB_RESERVE_JOB
        ...
        'Get Select Statement for table TB_RESERVE_JOB
