...
Namespace Table
    'Represents a transaction for TB_DEPARTMENT table DAL.
    '[Create by  on December, 25 2010]
    Public Class TbDepartmentDAL
        Public Sub TbDepartmentDAL()

        End Sub
        ' TB_DEPARTMENT
        Const _tableName As String = "TB_DEPARTMENT"
        ...
        'Generate Field List
        Dim _ID As Long = 0
        Dim _DEPARTMENT_CODE As String = ""
        ...
        '/// Returns an indication whether the current data is inserted into TB_DEPARTMENT table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_DEPARTMENT table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_DEPARTMENT table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_DEPARTMENT by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_DEPARTMENT by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbDepartmentData
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if update data successfully; otherwise, false.</returns>
        Public Function UpdateByDEPARTMENT_CODE(ByVal cDEPARTMENT_CODE As String, ByVal UserID As String, ByVal trans As SQLTransaction) As Boolean
            _UPDATEBY = UserID
            _UPDATEON = DateTime.Now
            Return doUpdate("DEPARTMENT_CODE = " & DB.SetString(cDEPARTMENT_CODE) & " ", trans)
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if delete data successfully; otherwise, false.</returns>
        Public Function DeleteByDEPARTMENT_CODE(ByVal cDEPARTMENT_CODE As String, ByVal trans As SQLTransaction) As Boolean
            Return doDelete("DEPARTMENT_CODE = " & DB.SetString(cDEPARTMENT_CODE) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_DEPARTMENT by specified DEPARTMENT_CODE key is retrieved successfully.
        '/// <param name=cDEPARTMENT_CODE>The DEPARTMENT_CODE key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByDEPARTMENT_CODE(ByVal cDEPARTMENT_CODE As String, ByVal trans As SQLTransaction) As Boolean
            Return doChkData("DEPARTMENT_CODE = " & DB.SetString(cDEPARTMENT_CODE) & " ", trans)
        End Function

        '/// Returns an indication whether the Data Class of TB_DEPARTMENT by specified DEPARTMENT_CODE key is retrieved successfully.
        '/// <param name=cDEPARTMENT_CODE>The DEPARTMENT_CODE key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByDEPARTMENT_CODE(ByVal cDEPARTMENT_CODE As String, ByVal trans As SQLTransaction) As TbDepartmentData
            Return doGetMappingData("DEPARTMENT_CODE = " & DB.SetString(cDEPARTMENT_CODE) & " ", trans)
        End Function

        '/// Returns an indication whether the record of TB_DEPARTMENT by specified condition is retrieved successfully.
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("department_code")) = False Then _department_code = Rdr("department_code").ToString()
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_DEPARTMENT by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbDepartmentData, ByVal RDr As DataRow) As TbDepartmentData
            If Convert.IsDBNull(Rdr("id")) = False Then ret.ID = Convert.ToInt64(Rdr("id"))
            If Convert.IsDBNull(Rdr("department_code")) = False Then ret.DEPARTMENT_CODE = Rdr("department_code").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbDepartmentData
            ClearData()
            _haveData = False
            Dim ret As New TbDepartmentData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_DEPARTMENT
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, DEPARTMENT_CODE, DEPARTMENT_NAME, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetString(_DEPARTMENT_CODE) & ", "
                sql += DB.SetString(_DEPARTMENT_NAME) & ", "
        ...
        'Get update statement form table TB_DEPARTMENT
        Private ReadOnly Property SqlUpdate() As String
            Get
                Dim Sql As String = ""
                Sql += "UPDATE " & tableName & " SET "
                Sql += "ID = " & DB.SetDouble(_ID) & ", "
                Sql += "DEPARTMENT_CODE = " & DB.SetString(_DEPARTMENT_CODE) & ", "
                Sql += "DEPARTMENT_NAME = " & DB.SetString(_DEPARTMENT_NAME) & ", "
        ...
        'Get Delete Record in table TB_DEPARTMENT
        ...
        'Get Select Statement for table TB_DEPARTMENT
