...
Namespace Table
    'Represents a transaction for TB_OFFICER table DAL.
    '[Create by  on January, 13 2011]
    Public Class TbOfficerDAL
        Public Sub TbOfficerDAL()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbOfficerData
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if update data successfully; otherwise, false.</returns>
        Public Function UpdateByMIFARE_CARD_ID(ByVal cMIFARE_CARD_ID As String, ByVal UserID As String, ByVal trans As SQLTransaction) As Boolean
            _UPDATEBY = UserID
            _UPDATEON = DateTime.Now
            Return doUpdate("MIFARE_CARD_ID = " & DB.SetString(cMIFARE_CARD_ID) & " ", trans)
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if delete data successfully; otherwise, false.</returns>
        Public Function DeleteByMIFARE_CARD_ID(ByVal cMIFARE_CARD_ID As String, ByVal trans As SQLTransaction) As Boolean
            Return doDelete("MIFARE_CARD_ID = " & DB.SetString(cMIFARE_CARD_ID) & " ", trans)
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByMIFARE_CARD_ID(ByVal cMIFARE_CARD_ID As String, ByVal trans As SQLTransaction) As Boolean
            Return doChkData("MIFARE_CARD_ID = " & DB.SetString(cMIFARE_CARD_ID) & " ", trans)
        End Function

        '/// Returns an indication whether the Data Class of TB_OFFICER by specified MIFARE_CARD_ID key is retrieved successfully.
        '/// <param name=cMIFARE_CARD_ID>The MIFARE_CARD_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByMIFARE_CARD_ID(ByVal cMIFARE_CARD_ID As String, ByVal trans As SQLTransaction) As TbOfficerData
            Return doGetMappingData("MIFARE_CARD_ID = " & DB.SetString(cMIFARE_CARD_ID) & " ", trans)
        End Function
        ...
        '/// Returns an indication whether the Data Class of TB_OFFICER by specified USERNAME key is retrieved successfully.
        '/// <param name=cUSERNAME>The USERNAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByUSERNAME(ByVal cUSERNAME As String, ByVal trans As SQLTransaction) As TbOfficerData
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_OFFICER by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbOfficerData, ByVal RDr As DataRow) As TbOfficerData
            If Convert.IsDBNull(Rdr("id")) = False Then ret.ID = Convert.ToInt64(Rdr("id"))
            If Convert.IsDBNull(Rdr("officer_no")) = False Then ret.OFFICER_NO = Rdr("officer_no").ToString()
            ...
            If Convert.IsDBNull(Rdr("mifare_card_id")) = False Then ret.MIFARE_CARD_ID = Rdr("mifare_card_id").ToString()
            Return ret
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbOfficerData
            ClearData()
            _haveData = False
            Dim ret As New TbOfficerData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, OFFICER_NO, FNAME, LNAME, DEPARTMENT_ID, POSITION_ID, USERNAME, PASSWORD, CREATEBY, CREATEON, UPDATEBY, UPDATEON, TITLE_ID, MIFARE_CARD_ID)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetString(_OFFICER_NO) & ", "
                sql += DB.SetString(_FNAME) & ", "
                sql += DB.SetString(_LNAME) & ", "
                sql += DB.SetDouble(_DEPARTMENT_ID) & ", "
                sql += DB.SetDouble(_POSITION_ID) & ", "
                ...
                sql += DB.SetString(_MIFARE_CARD_ID)
                sql += ")"
                Return sql
            End Get
        End Property
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "OFFICER_NO = " & DB.SetString(_OFFICER_NO) & ", "
                Sql += "FNAME = " & DB.SetString(_FNAME) & ", "
                Sql += "LNAME = " & DB.SetString(_LNAME) & ", "
                Sql += "DEPARTMENT_ID = " & DB.SetDouble(_DEPARTMENT_ID) & ", "
                Sql += "POSITION_ID = " & DB.SetDouble(_POSITION_ID) & ", "
                ...
                Sql += "MIFARE_CARD_ID = " & DB.SetString(_MIFARE_CARD_ID) + ""
                Return Sql
            End Get
        End Property
