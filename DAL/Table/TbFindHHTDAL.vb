...
Namespace Table
    'Represents a transaction for TB_FIND_HHT table DAL.
    '[Create by  on January, 20 2011]
    Public Class TbFindHHTDAL
        Public Sub TbFindHHTDAL()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbFindHHTData
        ...
        '/// Returns an indication whether the Data Class of TB_FIND_HHT by specified APP_NO key is retrieved successfully.
        '/// <param name=cAPP_NO>The APP_NO key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByAPP_NO(ByVal cAPP_NO As String, ByVal trans As SQLTransaction) As TbFindHHTData
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_FIND_HHT by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbFindHHTData, ByVal RDr As DataRow) As TbFindHHTData
            If Convert.IsDBNull(Rdr("id")) = False Then ret.ID = Convert.ToInt64(Rdr("id"))
            If Convert.IsDBNull(Rdr("app_no")) = False Then ret.APP_NO = Rdr("app_no").ToString()
            If Convert.IsDBNull(Rdr("load_datetime")) = False Then ret.LOAD_DATETIME = Convert.ToDateTime(Rdr("load_datetime"))
            If Convert.IsDBNull(Rdr("load_type")) = False Then ret.LOAD_TYPE = Rdr("load_type").ToString()
            If Convert.IsDBNull(Rdr("find_status")) = False Then ret.FIND_STATUS = Rdr("find_status").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbFindHHTData
            ClearData()
            _haveData = False
            Dim ret As New TbFindHHTData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String
            Get
                ...
                sql += DB.SetDateTime(_LOAD_DATETIME) & ", "
                sql += DB.SetString(_LOAD_TYPE) & ", "
                sql += DB.SetString(_FIND_STATUS) & ", "
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "LOAD_DATETIME = " & DB.SetDateTime(_LOAD_DATETIME) & ", "
                Sql += "LOAD_TYPE = " & DB.SetString(_LOAD_TYPE) & ", "
                Sql += "FIND_STATUS = " & DB.SetString(_FIND_STATUS) & ", "
