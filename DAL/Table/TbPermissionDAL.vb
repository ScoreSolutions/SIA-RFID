...
Namespace Table
    'Represents a transaction for TB_PERMISSION table DAL.
    '[Create by  on December, 25 2010]
    Public Class TbPermissionDAL
        Public Sub TbPermissionDAL()

        End Sub
        ' TB_PERMISSION
        Const _tableName As String = "TB_PERMISSION"
        ...
        '/// Returns an indication whether the current data is inserted into TB_PERMISSION table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_PERMISSION table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_PERMISSION table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_PERMISSION by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_PERMISSION by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbPermissionData
            Return doGetMappingData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_PERMISSION by specified condition is retrieved successfully.
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("Permission_name")) = False Then _Permission_name = Rdr("Permission_name").ToString()
                        If Convert.IsDBNull(Rdr("permission_desc")) = False Then _permission_desc = Rdr("permission_desc").ToString()
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_PERMISSION by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbPermissionData, ByVal RDr As DataRow) As TbPermissionData
            If Convert.IsDBNull(Rdr("id")) = False Then ret.ID = Convert.ToInt64(Rdr("id"))
            If Convert.IsDBNull(Rdr("Permission_name")) = False Then ret.PERMISSION_NAME = Rdr("Permission_name").ToString()
            If Convert.IsDBNull(Rdr("permission_desc")) = False Then ret.PERMISSION_DESC = Rdr("permission_desc").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbPermissionData
            ClearData()
            _haveData = False
            Dim ret As New TbPermissionData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_PERMISSION
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, PERMISSION_NAME, PERMISSION_DESC, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetString(_PERMISSION_NAME) & ", "
                sql += DB.SetString(_PERMISSION_DESC) & ", "
        ...
        'Get update statement form table TB_PERMISSION
        Private ReadOnly Property SqlUpdate() As String
            Get
                Dim Sql As String = ""
                Sql += "UPDATE " & tableName & " SET "
                Sql += "ID = " & DB.SetDouble(_ID) & ", "
                Sql += "PERMISSION_NAME = " & DB.SetString(_PERMISSION_NAME) & ", "
                Sql += "PERMISSION_DESC = " & DB.SetString(_PERMISSION_DESC) & ", "
        ...
        'Get Delete Record in table TB_PERMISSION
        ...
        'Get Select Statement for table TB_PERMISSION
