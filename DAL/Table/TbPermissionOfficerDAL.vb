...
Namespace Table
    'Represents a transaction for TB_PERMISSION_OFFICER table DAL.
    '[Create by  on December, 25 2010]
    Public Class TbPermissionOfficerDAL
        Public Sub TbPermissionOfficerDAL()

        End Sub
        ' TB_PERMISSION_OFFICER
        Const _tableName As String = "TB_PERMISSION_OFFICER"
        ...
        Public ReadOnly Property ID() As Long
            ...
            End Get
        End Property
        Public Property PERMISSION_ID() As Long
            Get
        ...
        '/// Returns an indication whether the current data is inserted into TB_PERMISSION_OFFICER table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_PERMISSION_OFFICER table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_PERMISSION_OFFICER table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_PERMISSION_OFFICER by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_PERMISSION_OFFICER by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbPermissionOfficerData
            Return doGetMappingData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_PERMISSION_OFFICER by specified condition is retrieved successfully.
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("permission_id")) = False Then _permission_id = Convert.ToInt64(Rdr("permission_id"))
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_PERMISSION_OFFICER by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbPermissionOfficerData, ByVal RDr As DataRow) As TbPermissionOfficerData
            If Convert.IsDBNull(Rdr("id")) = False Then ret.ID = Convert.ToInt64(Rdr("id"))
            If Convert.IsDBNull(Rdr("permission_id")) = False Then ret.PERMISSION_ID = Convert.ToInt64(Rdr("permission_id"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbPermissionOfficerData
            ClearData()
            _haveData = False
            Dim ret As New TbPermissionOfficerData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_PERMISSION_OFFICER
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, PERMISSION_ID, OFFICER_ID, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetDouble(_PERMISSION_ID) & ", "
        ...
        'Get update statement form table TB_PERMISSION_OFFICER
        Private ReadOnly Property SqlUpdate() As String
            Get
                Dim Sql As String = ""
                Sql += "UPDATE " & tableName & " SET "
                Sql += "ID = " & DB.SetDouble(_ID) & ", "
                Sql += "PERMISSION_ID = " & DB.SetDouble(_PERMISSION_ID) & ", "
        ...
        'Get Delete Record in table TB_PERMISSION_OFFICER
        ...
        'Get Select Statement for table TB_PERMISSION_OFFICER
