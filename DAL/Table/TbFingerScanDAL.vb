...
Namespace Table
    'Represents a transaction for TB_FINGERSCAN table DAL.
    '[Create by  on December, 25 2010]
    Public Class TbFingerScanDAL
        Public Sub TbFingerScanDAL()
        ...
        Dim _SCAN_DATETIME As DateTime = New DateTime(1, 1, 1)
        ...
        Public Property OFFICER_ID() As Long
            ...
            End Set
        End Property
        Public Property SCAN_DATETIME() As DateTime
            Get
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbFingerScanData
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_FINGERSCAN by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbFingerScanData, ByVal RDr As DataRow) As TbFingerScanData
            If Convert.IsDBNull(Rdr("id")) = False Then ret.ID = Convert.ToInt64(Rdr("id"))
            If Convert.IsDBNull(Rdr("officer_id")) = False Then ret.OFFICER_ID = Convert.ToInt64(Rdr("officer_id"))
            If Convert.IsDBNull(Rdr("scan_datetime")) = False Then ret.SCAN_DATETIME = Convert.ToDateTime(Rdr("scan_datetime"))
            If Convert.IsDBNull(Rdr("direction")) = False Then ret.DIRECTION = Rdr("direction").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbFingerScanData
            ClearData()
            _haveData = False
            Dim ret As New TbFingerScanData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String
            Get
                ...
                sql += DB.SetDateTime(_SCAN_DATETIME) & ", "
                sql += DB.SetString(_DIRECTION) & ", "
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "SCAN_DATETIME = " & DB.SetDateTime(_SCAN_DATETIME) & ", "
                Sql += "DIRECTION = " & DB.SetString(_DIRECTION) & ", "
