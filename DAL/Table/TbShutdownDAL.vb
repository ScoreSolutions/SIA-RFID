...
Namespace Table
    'Represents a transaction for TB_SHUTDOWS table DAL.
    '[Create by  on December, 25 2010]
    Public Class TbShutdownDAL
        Public Sub TbShutdownDAL()

        End Sub
        ' TB_SHUTDOWS
        Const _tableName As String = "TB_SHUTDOWS"
        ...
        '/// Returns an indication whether the current data is inserted into TB_SHUTDOWS table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_SHUTDOWS table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_SHUTDOWS table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_SHUTDOWS by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_SHUTDOWS by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbShutdownData
            Return doGetMappingData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_SHUTDOWS by specified condition is retrieved successfully.
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_SHUTDOWS by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbShutdownData, ByVal RDr As DataRow) As TbShutdownData
            If Convert.IsDBNull(Rdr("id")) = False Then ret.ID = Convert.ToInt64(Rdr("id"))
            If Convert.IsDBNull(Rdr("com_name")) = False Then ret.COM_NAME = Rdr("com_name").ToString()
            If Convert.IsDBNull(Rdr("open_datetime")) = False Then ret.OPEN_DATETIME = Convert.ToDateTime(Rdr("open_datetime"))
            If Convert.IsDBNull(Rdr("close_datetime")) = False Then ret.CLOSE_DATETIME = Convert.ToDateTime(Rdr("close_datetime"))
            If Convert.IsDBNull(Rdr("s_status")) = False Then ret.S_STATUS = Rdr("s_status").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbShutdownData
            ClearData()
            _haveData = False
            Dim ret As New TbShutdownData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_SHUTDOWS
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, COM_NAME, OPEN_DATETIME, CLOSE_DATETIME, S_STATUS, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetString(_COM_NAME) & ", "
                sql += DB.SetDateTime(_OPEN_DATETIME) & ", "
                sql += DB.SetDateTime(_CLOSE_DATETIME) & ", "
                sql += DB.SetString(_S_STATUS) & ", "
        ...
        'Get update statement form table TB_SHUTDOWS
        Private ReadOnly Property SqlUpdate() As String
            Get
                Dim Sql As String = ""
                Sql += "UPDATE " & tableName & " SET "
                Sql += "ID = " & DB.SetDouble(_ID) & ", "
                Sql += "COM_NAME = " & DB.SetString(_COM_NAME) & ", "
                Sql += "OPEN_DATETIME = " & DB.SetDateTime(_OPEN_DATETIME) & ", "
                Sql += "CLOSE_DATETIME = " & DB.SetDateTime(_CLOSE_DATETIME) & ", "
                Sql += "S_STATUS = " & DB.SetString(_S_STATUS) & ", "
        ...
        'Get Delete Record in table TB_SHUTDOWS
        ...
        'Get Select Statement for table TB_SHUTDOWS
