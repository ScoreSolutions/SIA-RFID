...
Namespace Table
    'Represents a transaction for TB_SETUP table DAL.
    '[Create by  on December, 25 2010]
    Public Class TbSetupDAL
        Public Sub TbSetupDAL()

        End Sub
        ' TB_SETUP
        Const _tableName As String = "TB_SETUP"
        ...
        '/// Returns an indication whether the current data is inserted into TB_SETUP table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_SETUP table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_SETUP table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_SETUP by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_SETUP by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbSetupData
            Return doGetMappingData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_SETUP by specified condition is retrieved successfully.
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("Setup_name")) = False Then _Setup_name = Rdr("Setup_name").ToString()
                        If Convert.IsDBNull(Rdr("Setup_value")) = False Then _Setup_value = Rdr("Setup_value").ToString()
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_SETUP by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbSetupData, ByVal RDr As DataRow) As TbSetupData
            If Convert.IsDBNull(Rdr("id")) = False Then ret.ID = Convert.ToInt64(Rdr("id"))
            If Convert.IsDBNull(Rdr("Setup_name")) = False Then ret.SETUP_NAME = Rdr("Setup_name").ToString()
            If Convert.IsDBNull(Rdr("Setup_value")) = False Then ret.SETUP_VALUE = Rdr("Setup_value").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbSetupData
            ClearData()
            _haveData = False
            Dim ret As New TbSetupData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_SETUP
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, SETUP_NAME, SETUP_VALUE, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetString(_SETUP_NAME) & ", "
                sql += DB.SetString(_SETUP_VALUE) & ", "
        ...
        'Get update statement form table TB_SETUP
        Private ReadOnly Property SqlUpdate() As String
            Get
                Dim Sql As String = ""
                Sql += "UPDATE " & tableName & " SET "
                Sql += "ID = " & DB.SetDouble(_ID) & ", "
                Sql += "SETUP_NAME = " & DB.SetString(_SETUP_NAME) & ", "
                Sql += "SETUP_VALUE = " & DB.SetString(_SETUP_VALUE) & ", "
        ...
        'Get Delete Record in table TB_SETUP
        ...
        'Get Select Statement for table TB_SETUP
