...
Namespace Table
    'Represents a transaction for TB_ALARM_LOG table DAL.
    '[Create by  on December, 25 2010]
    Public Class TbAlarmLogDAL
        Public Sub TbAlarmLogDAL()
        ...
        Private Sub ClearData()
            _ID = 0
            _ALARM_DATETIME = New DateTime(1, 1, 1)
            _REQUISITION_ID = 0
            _CREATEBY = ""
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbAlarmLogData
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("alarm_datetime")) = False Then _alarm_datetime = Convert.ToDateTime(Rdr("alarm_datetime"))
                        If Convert.IsDBNull(Rdr("requisition_id")) = False Then _requisition_id = Convert.ToInt64(Rdr("requisition_id"))
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_ALARM_LOG by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbAlarmLogData, ByVal RDr As DataRow) As TbAlarmLogData
            If Convert.IsDBNull(Rdr("id")) = False Then ret.ID = Convert.ToInt64(Rdr("id"))
            If Convert.IsDBNull(Rdr("alarm_datetime")) = False Then ret.ALARM_DATETIME = Convert.ToDateTime(Rdr("alarm_datetime"))
            If Convert.IsDBNull(Rdr("requisition_id")) = False Then ret.REQUISITION_ID = Convert.ToInt64(Rdr("requisition_id"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbAlarmLogData
            ClearData()
            _haveData = False
            Dim ret As New TbAlarmLogData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, ALARM_DATETIME, REQUISITION_ID, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetDateTime(_ALARM_DATETIME) & ", "
                sql += DB.SetDouble(_REQUISITION_ID) & ", "
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "ALARM_DATETIME = " & DB.SetDateTime(_ALARM_DATETIME) & ", "
                Sql += "REQUISITION_ID = " & DB.SetDouble(_REQUISITION_ID) & ", "
