...
Namespace Table
    'Represents a transaction for TB_PERMISSION_MENU table DAL.
    '[Create by  on December, 25 2010]
    Public Class TbPermissionMenuDAL
        Public Sub TbPermissionMenuDAL()

        End Sub
        ' TB_PERMISSION_MENU
        Const _tableName As String = "TB_PERMISSION_MENU"
        ...
        '/// Returns an indication whether the current data is inserted into TB_PERMISSION_MENU table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_PERMISSION_MENU table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_PERMISSION_MENU table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_PERMISSION_MENU by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_PERMISSION_MENU by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbPermissionMenuData
            Return doGetMappingData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_PERMISSION_MENU by specified condition is retrieved successfully.
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_PERMISSION_MENU by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbPermissionMenuData, ByVal RDr As DataRow) As TbPermissionMenuData
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbPermissionMenuData
            ClearData()
            _haveData = False
            Dim ret As New TbPermissionMenuData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_PERMISSION_MENU
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, PERMISSION_ID, MENU_ID, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
        ...
        'Get update statement form table TB_PERMISSION_MENU
        ...
        'Get Delete Record in table TB_PERMISSION_MENU
        ...
        'Get Select Statement for table TB_PERMISSION_MENU
