...
Namespace Table
    'Represents a transaction for TB_MENU table DAL.
    '[Create by  on December, 25 2010]
    Public Class TbMenuDAL
        Public Sub TbMenuDAL()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbMenuData
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_MENU by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbMenuData, ByVal RDr As DataRow) As TbMenuData
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbMenuData
            ClearData()
            _haveData = False
            Dim ret As New TbMenuData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, MENU_NAME, MENU_TOOLTIP, MENU_URL, MODULE_ID, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetString(_MENU_NAME) & ", "
                sql += DB.SetString(_MENU_TOOLTIP) & ", "
                sql += DB.SetString(_MENU_URL) & ", "
                sql += DB.SetString(_MODULE_ID) & ", "
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "MENU_TOOLTIP = " & DB.SetString(_MENU_TOOLTIP) & ", "
                Sql += "MENU_URL = " & DB.SetString(_MENU_URL) & ", "
                Sql += "MODULE_ID = " & DB.SetString(_MODULE_ID) & ", "
