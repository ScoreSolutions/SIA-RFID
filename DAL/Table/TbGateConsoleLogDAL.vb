...
Namespace Table
    'Represents a transaction for TB_GATE_CONSOLE_LOG table DAL.
    '[Create by  on January, 24 2011]
    Public Class TbGateConsoleLogDAL
        Public Sub TbGateConsoleLogDAL()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbGateConsoleLogData
        ...
        '/// Returns an indication whether the record of TB_GATE_CONSOLE_LOG by specified APP_NO key is retrieved successfully.
        ...
        '/// Returns an indication whether the Data Class of TB_GATE_CONSOLE_LOG by specified APP_NO key is retrieved successfully.
        '/// <param name=cAPP_NO>The APP_NO key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByAPP_NO(ByVal cAPP_NO As String, ByVal trans As SQLTransaction) As TbGateConsoleLogData
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_GATE_CONSOLE_LOG by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbGateConsoleLogData, ByVal RDr As DataRow) As TbGateConsoleLogData
            If Convert.IsDBNull(Rdr("id")) = False Then ret.ID = Convert.ToInt64(Rdr("id"))
            If Convert.IsDBNull(Rdr("app_no")) = False Then ret.APP_NO = Rdr("app_no").ToString()
            If Convert.IsDBNull(Rdr("timestamp")) = False Then ret.TIMESTAMP = Convert.ToDateTime(Rdr("timestamp"))
            If Convert.IsDBNull(Rdr("isalarm")) = False Then ret.ISALARM = Rdr("isalarm").ToString()
            If Convert.IsDBNull(Rdr("alarm_disable_time")) = False Then ret.ALARM_DISABLE_TIME = Convert.ToDateTime(Rdr("alarm_disable_time"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbGateConsoleLogData
            ClearData()
            _haveData = False
            Dim ret As New TbGateConsoleLogData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, APP_NO, TIMESTAMP, ISALARM, ALARM_DISABLE_TIME, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetString(_APP_NO) & ", "
                sql += DB.SetDateTime(_TIMESTAMP) & ", "
                sql += DB.SetString(_ISALARM) & ", "
                sql += DB.SetDateTime(_ALARM_DISABLE_TIME) & ", "
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "TIMESTAMP = " & DB.SetDateTime(_TIMESTAMP) & ", "
                Sql += "ISALARM = " & DB.SetString(_ISALARM) & ", "
                Sql += "ALARM_DISABLE_TIME = " & DB.SetDateTime(_ALARM_DISABLE_TIME) & ", "
