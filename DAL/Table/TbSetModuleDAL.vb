...
Namespace Table
    'Represents a transaction for TB_SETMODULE table DAL.
    '[Create by  on April, 21 2014]
    Public Class TbSetModuleDAL
        Public Sub TbSetModuleDAL()

        End Sub
        ' TB_SETMODULE
        Const _tableName As String = "TB_SETMODULE"
        ...
        Public ReadOnly Property ID() As Long
            ...
            End Get
        End Property
        Public Property SETACTION() As String
            Get
                Return _SETACTION
            End Get
        ...
        '/// Returns an indication whether the current data is inserted into TB_SETMODULE table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_SETMODULE table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_SETMODULE table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_SETMODULE by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_SETMODULE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByID(ByVal cid As Long, ByVal trans As SqlTransaction) As TbSetModuleDAL
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_SETMODULE by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("setaction")) = False Then _setaction = Rdr("setaction").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(ByVal whText As String, ByVal trans As SQLTransaction) As TbSetModuleDAL
            ClearData()
            _haveData = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_SETMODULE
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, SETACTION, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetString(_SETACTION) & ", "
        ...
        'Get update statement form table TB_SETMODULE
        Private ReadOnly Property SqlUpdate() As String
            Get
                Dim Sql As String = ""
                Sql += "UPDATE " & tableName & " SET "
                Sql += "ID = " & DB.SetDouble(_ID) & ", "
                Sql += "SETACTION = " & DB.SetString(_SETACTION) & ", "
        ...
        'Get Delete Record in table TB_SETMODULE
        ...
        'Get Select Statement for table TB_SETMODULE
