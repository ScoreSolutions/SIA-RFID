...
Namespace Table
    'Represents a transaction for TB_SETALARM table DAL.
    '[Create by  on December, 25 2010]
    Public Class TbSetAlarmDAL
        Public Sub TbSetAlarmDAL()

        End Sub
        ' TB_SETALARM
        Const _tableName As String = "TB_SETALARM"
        ...
        Public ReadOnly Property ID() As Long
            ...
            End Get
        End Property
        Public Property SETALARM() As String
            Get
                Return _SETALARM
            End Get
        ...
        '/// Returns an indication whether the current data is inserted into TB_SETALARM table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_SETALARM table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_SETALARM table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_SETALARM by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_SETALARM by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbSetAlarmData
            Return doGetMappingData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_SETALARM by specified condition is retrieved successfully.
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("setalarm")) = False Then _setalarm = Rdr("setalarm").ToString()
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_SETALARM by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbSetAlarmData, ByVal RDr As DataRow) As TbSetAlarmData
            If Convert.IsDBNull(Rdr("id")) = False Then ret.ID = Convert.ToInt64(Rdr("id"))
            If Convert.IsDBNull(Rdr("setalarm")) = False Then ret.SETALARM = Rdr("setalarm").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbSetAlarmData
            ClearData()
            _haveData = False
            Dim ret As New TbSetAlarmData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_SETALARM
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, SETALARM, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetString(_SETALARM) & ", "
        ...
        'Get update statement form table TB_SETALARM
        Private ReadOnly Property SqlUpdate() As String
            Get
                Dim Sql As String = ""
                Sql += "UPDATE " & tableName & " SET "
                Sql += "ID = " & DB.SetDouble(_ID) & ", "
                Sql += "SETALARM = " & DB.SetString(_SETALARM) & ", "
        ...
        'Get Delete Record in table TB_SETALARM
        ...
        'Get Select Statement for table TB_SETALARM
