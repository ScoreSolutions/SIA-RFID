...
Namespace Table
    'Represents a transaction for TB_OFFICER_MENU table DAL.
    '[Create by  on December, 27 2010]
    Public Class TbOfficerMenuDAL
        Public Sub TbOfficerMenuDAL()

        End Sub
        ' TB_OFFICER_MENU
        Const _tableName As String = "TB_OFFICER_MENU"
        ...
        '/// Returns an indication whether the current data is inserted into TB_OFFICER_MENU table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_OFFICER_MENU table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_OFFICER_MENU table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_OFFICER_MENU by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_OFFICER_MENU by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbOfficerMenuData
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if update data successfully; otherwise, false.</returns>
        Public Function UpdateByMENU_ID_OFFICER_ID(ByVal cMENU_ID As Long, ByVal cOFFICER_ID As Long, ByVal UserID As String, ByVal trans As SQLTransaction) As Boolean
            _UPDATEBY = UserID
            _UPDATEON = DateTime.Now
            Return doUpdate("MENU_ID = " & DB.SetDouble(cMENU_ID) & " AND OFFICER_ID = " & DB.SetDouble(cOFFICER_ID), trans)
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if delete data successfully; otherwise, false.</returns>
        Public Function DeleteByMENU_ID_OFFICER_ID(ByVal cMENU_ID As Long, ByVal cOFFICER_ID As Long, ByVal trans As SQLTransaction) As Boolean
            Return doDelete("MENU_ID = " & DB.SetDouble(cMENU_ID) & " AND OFFICER_ID = " & DB.SetDouble(cOFFICER_ID), trans)
        End Function


        '/// Returns an indication whether the record of TB_OFFICER_MENU by specified MENU_ID_OFFICER_ID key is retrieved successfully.
        '/// <param name=cMENU_ID_OFFICER_ID>The MENU_ID_OFFICER_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByMENU_ID_OFFICER_ID(ByVal cMENU_ID As Long, ByVal cOFFICER_ID As Long, ByVal trans As SQLTransaction) As Boolean
            Return doChkData("MENU_ID = " & DB.SetDouble(cMENU_ID) & " AND OFFICER_ID = " & DB.SetDouble(cOFFICER_ID), trans)
        End Function

        '/// Returns an indication whether the Data Class of TB_OFFICER_MENU by specified MENU_ID_OFFICER_ID key is retrieved successfully.
        '/// <param name=cMENU_ID_OFFICER_ID>The MENU_ID_OFFICER_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByMENU_ID_OFFICER_ID(ByVal cMENU_ID As Long, ByVal cOFFICER_ID As Long, ByVal trans As SQLTransaction) As TbOfficerMenuData
            Return doGetMappingData("MENU_ID = " & DB.SetDouble(cMENU_ID) & " AND OFFICER_ID = " & DB.SetDouble(cOFFICER_ID), trans)
        End Function

        '/// Returns an indication whether the record of TB_OFFICER_MENU by specified condition is retrieved successfully.
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_OFFICER_MENU by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbOfficerMenuData, ByVal RDr As DataRow) As TbOfficerMenuData
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbOfficerMenuData
            ClearData()
            _haveData = False
            Dim ret As New TbOfficerMenuData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_OFFICER_MENU
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, OFFICER_ID, MENU_ID, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetDouble(_OFFICER_ID) & ", "
                sql += DB.SetDouble(_MENU_ID) & ", "
        ...
        'Get update statement form table TB_OFFICER_MENU
        Private ReadOnly Property SqlUpdate() As String
            Get
                Dim Sql As String = ""
                Sql += "UPDATE " & tableName & " SET "
                Sql += "ID = " & DB.SetDouble(_ID) & ", "
                Sql += "OFFICER_ID = " & DB.SetDouble(_OFFICER_ID) & ", "
                Sql += "MENU_ID = " & DB.SetDouble(_MENU_ID) & ", "
        ...
        'Get Delete Record in table TB_OFFICER_MENU
        ...
        'Get Select Statement for table TB_OFFICER_MENU
