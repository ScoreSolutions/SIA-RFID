...
Namespace Table
    'Represents a transaction for TB_SHUTDOWS_MENU table DAL.
    '[Create by  on December, 25 2010]
    Public Class TbShutdownsMenuDAL
        Public Sub TbShutdownsMenuDAL()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByid(ByVal cid As Long, ByVal trans As SQLTransaction) As TbShutdownsMenuData
        ...
        Private Function doChkData(ByVal whText As String, ByVal trans As SQLTransaction) As Boolean
            ...
            Return ret
        End Function
        '/// Returns an indication whether the Class Data of TB_SHUTDOWS_MENU by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingData(ByVal ret As TbShutdownsMenuData, ByVal RDr As DataRow) As TbShutdownsMenuData
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetMappingData(ByVal whText As String, ByVal trans As SQLTransaction) As TbShutdownsMenuData
            ClearData()
            _haveData = False
            Dim ret As New TbShutdownsMenuData
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
