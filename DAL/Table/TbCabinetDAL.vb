...
Namespace Table
    'Represents a transaction for TB_CABINET table DAL.
    '[Create by  on April, 25 2014]
    Public Class TbCabinetDAL
        Public Sub TbCabinetDAL()

        End Sub
        ' TB_CABINET
        Const _tableName As String = "TB_CABINET"
        ...
        '/// Returns an indication whether the current data is inserted into TB_CABINET table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_CABINET table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_CABINET table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_CABINET by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_CABINET by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(ByVal cid As Long, ByVal trans As SQLTransaction) As TbCabinetDAL
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_CABINET by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("cabinet_name")) = False Then _cabinet_name = Rdr("cabinet_name").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(ByVal whText As String, ByVal trans As SQLTransaction) As TbCabinetDAL
            ClearData()
            _haveData = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_CABINET
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, FLOOR_ID, ROOM_ID, CABINET_NAME, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetDouble(_FLOOR_ID) & ", "
                sql += DB.SetDouble(_ROOM_ID) & ", "
                sql += DB.SetString(_CABINET_NAME) & ", "
        ...
        'Get update statement form table TB_CABINET
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "CABINET_NAME = " & DB.SetString(_CABINET_NAME) & ", "
        ...
        'Get Delete Record in table TB_CABINET
        ...
        'Get Select Statement for table TB_CABINET
